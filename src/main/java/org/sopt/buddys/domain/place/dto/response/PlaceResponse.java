...
public record PlaceResponse(
    ...
    @Schema(description = "국가명(구글 표기, 한글). 구글이 주소 구성요소를 안 줄 경우 null", example = "프랑스",
        requiredMode = Schema.RequiredMode.REQUIRED, nullable = true) String country,
    @Schema(description = "도시명(구글 표기, 한글). locality가 없으면 상위 행정구역으로 대체, 그래도 없으면 null",
        example = "파리", requiredMode = Schema.RequiredMode.REQUIRED, nullable = true) String city
) {
