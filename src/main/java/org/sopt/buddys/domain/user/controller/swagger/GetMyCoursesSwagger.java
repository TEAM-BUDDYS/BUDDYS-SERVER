...
@Operation(summary = "내가 작성한 코스 목록 조회", description = "로그인한 사용자가 작성한 코스 목록을 조회합니다.")
@ApiResponses({
    @ApiResponse(responseCode = "200", description = "내가 작성한 코스 목록 조회 성공")
})
@InvalidRequestResponse
@UserNotFoundResponse
@CommonErrorResponses
public @interface GetMyCoursesSwagger {
}
